...
public class OpenShiftVillainIT {

    static final String POSTGRESQL_USER = "superbad";
    static final String POSTGRESQL_PASSWORD = "superbad";
    static final String POSTGRESQL_DATABASE = "villains-database";
    static final int POSTGRESQL_PORT = 5432;

    static final int DEFAULT_LEVEL = 42;
    static final int UPDATED_LEVEL = 43;
    static final int LEVEL_MULTIPLICATION = 2;
    ...
    @QuarkusApplication(gitRepositoryUri = "https://github.com/quarkusio/quarkus-workshops.git", contextDir = "quarkus-workshop-super-heroes/super-heroes/rest-villain")
